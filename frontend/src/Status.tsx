...
const SUPERIOR = [
  ...
  '自動化測試 pytest 123/123(含合成夾具斷言圖片排列位置)',
]
const PARITY = [
...
const UNIT_TESTS: Row[] = [
  ['後端自動化測試 pytest', 'uv run pytest', '123/123 通過', true],
  ...
  return (
    <div className="panel">
      ...
      <p className="hint" style={{ marginTop: 0 }}>
        ...
        <b>第一輪</b>發現多模組缺單元測試 → <b>分三輪補了 87 個測試(pytest 48→123 + 前端 12 vitest)</b> → 稽核分全面回升至 78–88。
  ...
  return (
    <div className="status-page">
      <div className="stat-cards">
        ...
        <Stat label="後端測試" value="123/123 ✓" ok />
      ...
      <div className="panel">
        ...
        <p className="hint">後端 <code>uv run pytest</code> 123/123;前端以隔離瀏覽器經 tunnel 實測。</p>
      </div>
