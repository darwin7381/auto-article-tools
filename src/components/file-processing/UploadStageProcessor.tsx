...
interface UploadStageProcessorProps {
  // 文件上傳相關
  ...
  // 共用屬性
  onUploadComplete: (fileUrl: string, fileType: string, fileId: string) => void;
 ...
 */
export default function UploadStageProcessor({
  selectedFile,
  setUploadSuccess,
  setUploadError,
  setIsUploading,
  ...
  const processFileUpload = async () => {
    ...
    try {
      ...
      // 傳遞文件URL和類型給後續階段
      onUploadComplete(data.fileUrl, selectedFile.type, fileId);
    } catch (error) {
